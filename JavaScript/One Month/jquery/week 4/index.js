    ...
    $.ajax({
        ...
        success: function (response) {
            $.each(response.apartments, function (index, apartment) {
                ...
                var listing = '<a href = "#" id="' + apartment.id + '" class = "list-group-item ' + apartmentClass + ' listings"><h4 class="list-group-item-heading">' + apartment.description + ' / ' + apartment.bedrooms + ' / ' + apartment.price + '</h4><p class="list-group-item-text">' + apartment.neighborhood + '</p></a>';
    ...
    $(document).on("click", ".listings", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                address = selectedApartment[0].address;
